...
# run playbook
ansible-playbook jenkins-and-docker.yaml -l jenkins --check
...
ansible jenkins -m copy -a "src=jenkins-and-docker.yaml dest=/home mode=664" -b

ansible jenkins -m file -a "path=/home/jenkins-and-docker.yaml state=absent" 
